                       ...
                       String    newNodeID)
{
        ...
        case 0:
            ...
            if (oldC.has_value() && newC.has_value()) {
                Dresult =
                    edit->GetDiff<EDIT_ARG_NOTE>(oldC.value(), newC.value());
            }
            break;
        case 1:
            ...
            CommitSetter(oldC, newC, baseRepo);
            if (oldC.has_value() && newC.has_value()) {
                Dresult = edit->GetDiff<EDIT_ARG_KEY_VALUE>(oldC.value(),
                                                            newC.value());
            }
            break;
        case 2:
            ...
            if (oldC.has_value() && newC.has_value()) {
                Dresult =
                    edit->GetDiff<EDIT_ARG_MIX>(oldC.value(), newC.value());
            }
            break;
        case 3:
            ...
            if (oldC.has_value() && newC.has_value()) {
                Dresult =
                    edit->GetDiff<EDIT_ARG_MUSIC>(oldC.value(), newC.value());
            }
            break;
        default:
            return Dictionary();
